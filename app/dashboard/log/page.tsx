  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-50">Log Aktivitas</h2>
          <p className="text-muted-foreground dark:text-gray-50">Log aktivitas perangkat dan sistem</p>
        </div>
      </div>
