    ...
    <>
      ...
      <section className="relative py-20 bg-white dark:bg-gray-900 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(0,0,0,0.04)_1px,_transparent_1px)] dark:bg-[radial-gradient(circle_at_center,_rgba(255,255,255,0.05)_1px,_transparent_1px)] [background-size:2rem_2rem]"></div>
        </div>

        <div className="relative z-10 container mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 text-center md:text-left">
            <h2 className="text-3xl font-bold text-primary-800 dark:text-primary-100 mb-4">Tentang SIPEKA</h2>
      ...
      {/* Teknologi Section */}
      <section id="teknologi" className="py-20 bg-gray-50 dark:bg-gray-950">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <div className="flex items-center justify-center h-16 w-16 rounded-full bg-primary-100 dark:bg-primary-900/50 mb-6">
                <Cpu className="h-8 w-8 text-primary-600 dark:text-primary-300" />
              </div>
              <h3 className="text-xl font-semibold mb-3 text-gray-800 dark:text-gray-100">Perangkat Keras IoT</h3>
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <div className="flex items-center justify-center h-16 w-16 rounded-full bg-primary-100 dark:bg-primary-900/50 mb-6">
                <DatabaseZap className="h-8 w-8 text-primary-600 dark:text-primary-300" />
              </div>
              <h3 className="text-xl font-semibold mb-3 text-gray-800 dark:text-gray-100">Backend & Database</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <div className="flex items-center justify-center h-16 w-16 rounded-full bg-primary-100 dark:bg-primary-900/50 mb-6">
                <LayoutTemplate className="h-8 w-8 text-primary-600 dark:text-primary-300" />
              </div>
              <h3 className="text-xl font-semibold mb-3 text-gray-800 dark:text-gray-100">Frontend & Visualisasi</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
